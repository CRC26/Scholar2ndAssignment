package ie.wit.scholar.ui.home
...
import ie.wit.scholar.databinding.HomeBinding
import ie.wit.scholar.databinding.NavHeaderBinding
import ie.wit.scholar.firebase.FirebaseImageManager
import ie.wit.scholar.ui.auth.LoggedInViewModel
import ie.wit.scholar.ui.auth.Login
import ie.wit.scholar.utils.customTransformation
import ie.wit.scholar.utils.readImageUri
import ie.wit.scholar.utils.showImagePicker
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
            R.id.scholarlyFragment, R.id.reportFragment, R.id.aboutFragment), drawerLayout)
...
//            when(destination.id) {
//                R.id.reportFragment -> {
//                    val argument = NavArgument.Builder().setDefaultValue(totalScolared).build()
//                    destination.addArgument("totalScholared", argument)
//
//                }
//            }
//        }
